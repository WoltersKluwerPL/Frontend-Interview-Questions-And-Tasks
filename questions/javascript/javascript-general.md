...
* Imagine that you have a table with `1000` lines. You have a task to each row of the table, react to mouse clicks and perform some action.
...
* Why use `JSLint` / `JSHint` / `ESLint`? Or maybe not worth it? :)
